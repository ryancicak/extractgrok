...
public class ExtractGrok extends AbstractProcessor {
    ...
    public static final PropertyDescriptor GROK_EXPRESSION_ATTRIBUTE_BOOL = new PropertyDescriptor.Builder()
            .name("Grok Expression Attribute Boolean")
            .description("If set to true, the Grok expression shall reference an attribute name instead of the Grok expression")
            .required(true)
    ...
    static {
        ...
        _descriptors.add(GROK_EXPRESSION_ATTRIBUTE_BOOL);
    ...
    public void onScheduled(final ProcessContext context) throws GrokException {
        ...
        if(!context.getProperty(GROK_EXPRESSION_ATTRIBUTE_BOOL).asBoolean()) {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try {
            if (context.getProperty(GROK_EXPRESSION_ATTRIBUTE_BOOL).asBoolean()) {
                grok.compile(flowFile.getAttribute(context.getProperty(GROK_EXPRESSION).getValue()));
            }
        } catch (GrokException ex) {
            getLogger().error("Error with Grok Expression {}", new Object[]{flowFile});
        }
